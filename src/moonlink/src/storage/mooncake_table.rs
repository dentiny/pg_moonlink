...
impl MooncakeTable {
    ...
    pub(crate) fn set_iceberg_snapshot_res(&mut self, iceberg_snapshot_res: IcebergSnapshotResult) {
        ...
        self.next_snapshot_task.new_merged_file_indices = iceberg_snapshot_res
            .index_merge_result
            .new_file_indices_to_import;

        // TODO(hjiang): Could save the copy here.
        assert!(self.next_snapshot_task.old_merged_file_indices.is_empty());
        self.next_snapshot_task.old_merged_file_indices = iceberg_snapshot_res
            .index_merge_result
            .old_file_indices_to_remove
            .iter()
            .cloned()
            .collect::<HashSet<FileIndex>>();
    }
